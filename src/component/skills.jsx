...
export default function Skills() {
    ...
    return (
        <div id='skills' className="w-full h-[1100px] flex flex-col items-center overflow-hidden bg-blue-900 pt-[100px] z-[999]">
            ...
            <div className='xl:w-[300px] w-[150px] xl:h-[300px] h-[150px]  animate-[cloudmove3sm_5s_linear_infinite] xl:animate-[cloudmove2_20s_linear_infinite] ml-[0px] xl:mt-[600px] mt-[700px]  z-[99999] absolute bg-cover bg-center ' style={{ backgroundImage: `url(${cloudMove})`, transform: `translateX(-${scrollX}px)` }} ></div>
            <div>
            ...
            <div className='reveal shadow-[5px_5px_15px] bg-white w-[90%] xl:w-[90%] h-[80px] xl:h-[100px] flex justify-center items-center rounded-bl-2xl rounded-br-2xl ' >
            </div>
        </div>
    );
}
