                ...
                <div className='m-auto flex flex-col justify-center items-center'>
                    <div className='flex xl:flex-row flex-col ' >
                        <div className='xl:pr-[100px] pr-[0px] xl:ml-[20px] ml-[20px] mr-[] flex flex-col box-border w-full '>
                            <h1 className='reveal  xl:text-8xl text-5xl flex xl:mr-[50px] mr-[0px] xl:mb-[30px] mb-[20px] drop-shadow-[3px_3px_5px] ' >Wanna see my General Portfolio? </h1>
                        ...
                        <div className='reveal flex flex-col xl:ml-[50px] xl:mr-[50px] mr-[0px] shadow-[-10px_10px_20px] ' >
                            <div className='flex flex-row justify-center items-center w-full' >
                                <div style={{backgroundImage: `url(${potoPortGeneral1})`}} className='reveal w-[200px] h-[200px] bg-cover bg-center ' ></div>
                                <div style={{backgroundImage: `url(${potoPortGeneral2})`}} className='reveal w-[200px] h-[200px] bg-cover bg-center ' ></div>
                            </div>
                            <div className='flex flex-row justify-center items-center w-full' >
                                <div style={{backgroundImage: `url(${potoPortGeneral3})`}} className='reveal w-[200px] h-[200px] bg-cover bg-center ' ></div>
                                <div style={{backgroundImage: `url(${potoPortGeneral4})`}} className='reveal w-[200px] h-[200px] bg-cover bg-center ' ></div>
                            </div>
                        </div>
                    </div>
                    <h1 className='reveal text-6xl font-black w-full h-[100px] flex justify-center items-center mt-[100px] mb-[50px] drop-shadow-[2px_2px_5px] ' >Thank You</h1>
                </div>
            </div>
        </>
    )
