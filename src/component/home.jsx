...
export default function Home (){
  ...
  useEffect(() => {
    ...
    return (
        <>
            <div id='home' className="w-full h-[900px] xl:h-[700px] relative z-[-999999] bg-blue-400 xl:flex flex-cols justify-center" >
                <div className='border-solid relative overflow-hidden pt-[200px] xl:pt-[50px] border-black bor m-[0px] xl:w-[60%] w-[100%] flex  justify-center items-center  '  >
                    <div className='reveal pl-[20px] pr-[20px]' >
                        ...
                        <div className=' xl:text-start text-center' style={{ transform: `translateX(-${scrollX}px)` }} >
                            <TypeAnimation className=' text-[20px] xl:text-3xl font-medium' sequence={[
                        ...
                        <h3 className='text-xl xl:text-start text-center mt-[20px]' style={{ transform: `translateX(-${scrollX}px)` }} >I am an IT student currently studying at SMKN 69 Jakarta. I have the ability to imagine and apply my inspirations into a website or application designed using the programming languages that I have mastered, as stated in my skill information.</h3>
                    </div>
                ...
                <div className=" z-[999999] w-full overflow-hidden flex bottom-0 absolute whitespace-nowrap bg-gray-200 py-4">
                    <div className="flex w-max space-x-0 bottom-0 animate-[marque_20s_Linear_infinite]">
                        <p className='text-2xl  md:text-6xl uppercase mr-[50px] ' >🚀 This Website Portfolio is maked by Raafa Ibra Ardhefran🚀</p>
                    </div>
                    <div className="flex w-max space-x-0 bottom-0 animate-[marquee_20s_Linear_infinite]">
                        <p className='text-2xl  md:text-6xl uppercase mr-[50px] ' >🚀 This WebSite Portfolio is supported by Clara AngTa🚀</p>
                    </div>
